# PinTerm 0.4.1 — third-party notices

PinTerm's own application source is MIT licensed; see the top-level LICENSE at
<https://github.com/taotao7/PinTerm/tree/v0.4.1>. Third-party components retain
...
The release at <https://github.com/taotao7/PinTerm/releases/tag/v0.4.1> supplies
`PinTerm-0.4.1-ThirdPartySources.tar.gz` alongside the binary. It contains the
