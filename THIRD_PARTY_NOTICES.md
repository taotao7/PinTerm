# PinTerm 0.1.0 — third-party notices

PinTerm's own application source is MIT licensed; see the top-level LICENSE at
<https://github.com/taotao7/PinTerm/tree/v0.1.0>. Third-party components retain
...
The release at <https://github.com/taotao7/PinTerm/releases/tag/v0.1.0> supplies
`PinTerm-0.1.0-ThirdPartySources.tar.gz` alongside the binary. It contains the
