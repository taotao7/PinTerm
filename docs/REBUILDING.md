# Rebuilding and relinking PinTerm 0.4.1
...
Download the app source for tag `v0.4.1` and
`PinTerm-0.4.1-ThirdPartySources.tar.gz` from
<https://github.com/taotao7/PinTerm/releases/tag/v0.4.1>.
...
git clone --branch v0.4.1 https://github.com/taotao7/PinTerm.git "$WORK/PinTerm"
```
...
the app's complete MIT source at `v0.4.1` (including its build scripts), ship the
