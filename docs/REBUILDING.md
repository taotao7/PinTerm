# Rebuilding and relinking PinTerm 0.1.0
...
Download the app source for tag `v0.1.0` and
`PinTerm-0.1.0-ThirdPartySources.tar.gz` from
<https://github.com/taotao7/PinTerm/releases/tag/v0.1.0>.
...
git clone --branch v0.1.0 https://github.com/taotao7/PinTerm.git "$WORK/PinTerm"
```
...
the app's complete MIT source at `v0.1.0` (including its build scripts), ship the
